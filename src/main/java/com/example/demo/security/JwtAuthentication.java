		...
		http.sessionManagement(session-> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS));
	 	...
	 	http.cors(cors->{
	 		cors.configurationSource(request->{
	 			 ...
	 			 config.setAllowedOrigins(Arrays.asList("http://localhost:4200","http://localhost:8080","http://192.168.0.219:8080","http://localhost:3000","http://192.168.0.*:3000")); // Your Angular app's URL
