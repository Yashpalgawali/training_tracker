...
//	 			config.setAllowedOrigins(Arrays.asList("http://13.201.9.193")); // Your Angular app's URL
	 			 config.setAllowedOrigins(Arrays.asList("http://192.168.0.219:3000","http://localhost:8080","http://192.168.0.219:8080","http://localhost:8081","http://192.168.0.219:8081","http://localhost:3000")); // Your React app's URL
