...
public class CategoryController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "The category is saved Successfully "),
	...
	public ResponseEntity<ResponseDto> saveCompany(@RequestBody Category category) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(HttpStatus.CREATED.toString(),
				"Category " + savedCategory.getCategory() + " is saved Successfully"));
	}
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "The category is updated Successfully "),
	...
	public ResponseEntity<ResponseDto> updateCompany(@RequestBody Category category) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto(HttpStatus.OK.toString(),
				"Category " + category.getCategory() + " is Updated Successfully"));
	}
}
