...
public class TrainingController {
	...
	public ResponseEntity<ResponseDto> saveTraining(@RequestBody Training training) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(HttpStatus.CREATED.toString(), "Training "+training.getTraining_name()+" is saved successfully"));
	}
	...
	public ResponseEntity<ResponseDto> updateTraining(@RequestBody Training training) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto(HttpStatus.OK.toString(), "Training "+training.getTraining_name()+" is UPDATED successfully"));
	}
}
