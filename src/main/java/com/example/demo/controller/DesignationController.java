...
public class DesignationController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "The designation is saved Successfully "),
	...
	public ResponseEntity<ResponseDto> saveDesignation(@RequestBody Designation designation) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(HttpStatus.CREATED.toString(),
				"Designation " + savedDesignation.getDesigName() + " is saved Successfully"));
	}
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "The designation is found Successfully "),
	...
	public ResponseEntity<ResponseDto> updateDesignation(@RequestBody Designation designation) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto(HttpStatus.OK.toString(),
				"Designation " + updatedDesignation.getDesigName() + " is Updated Successfully"));
	}
}
